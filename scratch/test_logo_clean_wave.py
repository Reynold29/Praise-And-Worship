...
svg_logo_test = '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 850 900" width="850" height="900">
  <defs>
...
test_file = os.path.join(artifact_dir, "test_logo_clean_wave.svg")
with open(test_file, "w") as f:
    f.write(svg_logo_test)

subprocess.run(["qlmanage", "-t", "-s", "1024", "-o", artifact_dir, test_file], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
if os.path.exists(os.path.join(artifact_dir, "test_logo_clean_wave.svg.png")):
    os.replace(os.path.join(artifact_dir, "test_logo_clean_wave.svg.png"), os.path.join(artifact_dir, "test_logo_clean_wave.png"))

print("Saved test_logo_clean_wave.png")
