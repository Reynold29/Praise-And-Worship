            ...
            Row(
              ...
              children: [
                IconButton(
                  ...
                  onPressed: () =>
                      _launchURL('https://github.com/Reynold29', context),
                ),
                const SizedBox(width: 16),
                IconButton(
                  icon: const Icon(Icons.telegram),
                  onPressed: () =>
                      _launchURL('https://t.me/Reynold29', context),
                ),
                const SizedBox(width: 16),
                IconButton(
                  icon: const FaIcon(FontAwesomeIcons.circleUser),
                  onPressed: () => _launchURL(
                      'https://portfolio-reynold29.vercel.app/', context),
                ),
                const SizedBox(width: 16),
                IconButton(
                  icon: const FaIcon(FontAwesomeIcons.globe),
                  onPressed: () => _launchURL(
                      'https://projects.reyziehomelab.com/linkfree/index.html',
                      context),
                ),
              ],
            ),
